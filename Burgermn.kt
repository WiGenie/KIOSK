...
class Burgermn { //클래스는 대문자, 메인에서 클래스의 객체 생성할 때는 소문자
    var choicebg: Int = 0
            ...
            try {
                ...
                if (choicebg == 0) {
                    ...
                    when (singleorset) {
                        ...
                        1 -> {
                            print("단품을 선택하셨습니다. (0 입력시 돌아가기)수량을 정해주세요: ")
                        ...
                        2 -> {
                            print("세트를 선택하셨습니다. (0 입력시 돌아가기)수량을 정해주세요: ")
                            bgcount = readLine()!!.toInt()
                            when (bgcount) {
                                0 -> continue
                                else -> {
                                    ...
                                    bgorder.add(
                                        Orderlist(
                                            ...
                                            burgerlist[choicebg - 1].bgprice + setmn,
                                            bgcount
                                        )
                                    )
                                }
